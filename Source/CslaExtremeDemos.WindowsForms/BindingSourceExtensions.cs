...
namespace CslaExtremeDemos.WindowsForms
{
    ...
    public static class BindingSourceExtensions
    {
        ...
        public static void LocalRebind(this BindingSource source, object data)
        {
            source.LocalRebind(data, false);
        }
        ...
        public static void LocalRebind(this BindingSource source, object data, bool metadataChanged)
        {
