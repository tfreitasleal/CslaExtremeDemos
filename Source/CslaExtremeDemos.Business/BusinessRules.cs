...
namespace CslaExtremeDemos.Business
{
    ...
    public class LessThan : CommonBusinessRule
    {
        ...
        {
            return HasMessageDelegate ? base.GetMessage() : "LessThanRule";
        }
    ...
    public class LessThanOrEqual : CommonBusinessRule
    {
        ...
        protected override string GetMessage()
        {
            return HasMessageDelegate ? base.GetMessage() : "LessThanOrEqualRule";
        }
    ...
    public class GreaterThan : CommonBusinessRule
    {
        ...
        protected override string GetMessage()
        {
            return HasMessageDelegate ? base.GetMessage() : "GreaterThanRule";
        }
    ...
    public class GreaterThanOrEqual : CommonBusinessRule
    {
        ...
        protected override string GetMessage()
        {
            return HasMessageDelegate ? base.GetMessage() : "GreaterThanOrEqualRule";
        }
    ...
    public class Range : CommonBusinessRule
    {
        ...
        protected override string GetMessage()
        {
            return HasMessageDelegate ? base.GetMessage() : "RangeRule";
        }
    ...
    public class AnyRequired : CommonBusinessRule
    {
        ...
        /// <param name="errorMessageDelegate">The error message function.</param>
        /// <param name="additionalProperties">The additional properties.</param>
        public AnyRequired(IPropertyInfo primaryProperty, Func<string> errorMessageDelegate,
        ...
        protected override string GetMessage()
        {
            return HasMessageDelegate ? base.GetMessage() : "AnyRequiredRule";
        }
        ...
        where C : Csla.BusinessBase<C>
    {
        ...
        protected override string GetMessage()
        {
            return HasMessageDelegate ? base.GetMessage() : "NoDuplicatesRule";
        }
        ...
        protected override void Execute(RuleContext context)
        {
            ...
            if (parent != null)
            {
                if (
                    parent.Any(
                        item =>
                            value.Equals(Convert.ToString(ReadProperty(item, PrimaryProperty)),
